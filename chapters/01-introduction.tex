...
those obtained from segmentation-derived geometry. The aim is not to replace
...
compared with measurements obtained from segmentation-derived geometry. This
...
segmentation-derived geometry, and how does that agreement depend on the
measurement method?
\end{enumerate}
